...
export const tweets: Tweet[] = [
  {
    id: "1",
    content:
      "Just launched my new website! Check it out at example.com #webdev #react",
    user: users[1],
    createdAt: formatDistanceToNow(new Date(Date.now() - 1000 * 60 * 30), {
      addSuffix: true,
    }),
    likes: 45,
    retweets: 12,
  ...
  },
  {
    id: "2",
    content:
      "React 18 has some amazing new features. Loving the new concurrent rendering capabilities!",
    user: users[0],
    createdAt: formatDistanceToNow(new Date(Date.now() - 1000 * 60 * 60 * 2), {
      addSuffix: true,
    }),
    likes: 89,
    retweets: 23,
  ...
  },
  {
    ...
    user: users[2],
    createdAt: formatDistanceToNow(new Date(Date.now() - 1000 * 60 * 60 * 5), {
      addSuffix: true,
    }),
    likes: 123,
    retweets: 34,
    ...
    views: 3456,
    images: [
      "https://images.unsplash.com/photo-1495616811223-4d98c6e9c869?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80",
    ],
  },
  {
    id: "4",
    content:
      'Just finished reading "Atomic Habits" by James Clear. Highly recommend it to everyone!',
    user: users[1],
    createdAt: formatDistanceToNow(new Date(Date.now() - 1000 * 60 * 60 * 8), {
      addSuffix: true,
    }),
    likes: 67,
    retweets: 15,
  ...
  },
  {
    id: "5",
    content:
      "Working on a new project using TypeScript and React. The type safety is amazing!",
    user: users[0],
    createdAt: formatDistanceToNow(new Date(Date.now() - 1000 * 60 * 60 * 24), {
      addSuffix: true,
    }),
    likes: 56,
    retweets: 14,
